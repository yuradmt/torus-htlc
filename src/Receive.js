...
import { withdraw, findContractId } from './web3/htlc';
  ...
  return (
    <Form>
      ...
      <Button
        ...
        disabled={web3 === undefined || !contractId || !secret}
      >
      ...
      <Button
        variant="primary"
        type="submit"
        onClick={e => { e.preventDefault(); findContractId(receiver, setContractId); }}
        disabled={web3 === undefined || contractId}
        style={{ marginLeft: "10px" }}
      >
        {web3 ? 'Find Contract Id' : "Please login to Torus"}
      </Button>
    </Form>
  );
}
